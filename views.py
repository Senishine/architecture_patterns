...
from patterns.behavioral_patterns import EmailNotification, SmsNotification, ListView, CreateView, BaseSerializer, \
    ConsoleWriter

site = creational_patterns.Engine()
email_notifier = EmailNotification()
sms_notifier = SmsNotification()
logger = creational_patterns.Logger('main', ConsoleWriter())
routes = {}
